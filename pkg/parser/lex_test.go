...
func TestFunctionCalls(t *testing.T) {
	...
	assert.Equal(
		...
		[]Token{
			...
			{lexeme: "bar", tokenType: 30, start: 7, line: 1},
			{lexeme: ",", tokenType: 10, start: 10, line: 1},
			{lexeme: "\"shift\"", tokenType: 31, start: 12, line: 1},
			{lexeme: ")", tokenType: 3, start: 19, line: 1},
...
func TestNestedCallsAndChaining(t *testing.T) {
	...
	assert.Equal(
		...
		[]Token{
			...
			{lexeme: "(", tokenType: 2, start: 6, line: 1},
			{lexeme: "bar", tokenType: 30, start: 7, line: 1},
			{lexeme: "(", tokenType: 2, start: 10, line: 1},
			{lexeme: "baz", tokenType: 30, start: 11, line: 1},
			{lexeme: ")", tokenType: 3, start: 14, line: 1},
			{lexeme: ",", tokenType: 10, start: 15, line: 1},
			{lexeme: "\"shift\"", tokenType: 31, start: 17, line: 1},
			{lexeme: ")", tokenType: 3, start: 24, line: 1},
			{lexeme: ".", tokenType: 11, start: 25, line: 1},
			{lexeme: "qux", tokenType: 30, start: 26, line: 1},
